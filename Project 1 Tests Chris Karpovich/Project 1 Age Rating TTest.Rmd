...
ggplot(cleanmovies, aes(x=certificate, y=rating)) + 
  ...
  labs(title="IMDB Rating for Movies with different Age Ratings", x="Age Rating", y = "IMDB Rating")
...
```
```{r, echo=T}
#Time to look at another question, do history movies have a longer runtime than action movies?
history = subset(allmovies, )
