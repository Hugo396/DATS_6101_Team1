...
ggplot(data=post2010, aes(x=runtime)) + 
  geom_histogram(col="red", 
                 ...
                 alpha = .7) +
  labs(x="Runtime (mins)", y="Frequency") +
  labs(title="Distribution of Runtimes for Movies Produced After 2010") 
...
ggplot(yeartest, aes(x=timeframe, y=runtime)) + 
  ...
  labs(title="Boxplot of Runtime for Movies Before and After 2010", x="Timeframe", y = "Runtime (mins)")
